...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Group'
        db.create_table(u'usermanage_group', (
        ...
        db.send_create_signal(u'usermanage', ['Group'])

        # Adding model 'Membership'
        db.create_table(u'usermanage_membership', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['usermanage.Group'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=2)),
        ))
        db.send_create_signal(u'usermanage', ['Membership'])


    def backwards(self, orm):
        # Deleting model 'Group'
        db.delete_table(u'usermanage_group')

        # Deleting model 'Membership'
        db.delete_table(u'usermanage_membership')
