...
urlpatterns = patterns('',
    ...
    url(r'^question/add/(?P<group_id>[a-zA-Z0-9]+)', 'qset.views.addQuestion'),
    url(r'^subject/add/', 'qset.views.addSubject'),
    url(r'^account/questions/', 'qset.views.filterQuestions'),
    url(r'^group/(?P<group_id>[a-zA-Z0-9]+)/questions/$', 'qset.views.filterQuestions'),
    url(r'^group/(?P<group_id>[a-zA-Z0-9]+)/subtopic/$', 'qset.views.addSubTopic'),
    ...
    url(r'^ajax/subtopics/$', 'qset.views.getSubtopics'),
)
